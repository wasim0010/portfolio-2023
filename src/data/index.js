...
export const aboutMeData = [
  {
    id: 1,
    bio: "Achievement-oriented software developer . Eager to support CreeStal with reaching new prospective buyers  by improving the features and working speed of the company web app." }, 
  {
    id: 2,
